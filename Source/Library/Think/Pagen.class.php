...
class Page{
    ...
    private $config  = array(
        ...
        'first'  => '1...',
        'last'   => '...%TOTAL_PAGE%',
        'theme'  => '%FIRST% %UP_PAGE% %LINK_PAGE% %DOWN_PAGE%', //尾部去掉了 %END%
    );
     ...
     */
    public function __construct($totalRows, $listRows=20, $p) {
        !empty($p) && $this->p = $p; //设置分页参数名称
        /* 基础设置 */
